...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      'ui/src/plugins/datatables/datatables.min.js',
      'ui/src/plugins/highlightjs/highlight.pack.js',
      'ui/src/plugins/peity/jquery.peity.min.js',
      'ui/src/swsLayout.js',
      'ui/src/swsTable.js',
      'ui/src/swsuiWidget.js',
      'ui/src/swsuiChart.js',
      'ui/src/swsApiOpSel.js',
      'ui/src/sws.js',
      './test/ui/*.js',
      './test/ui/*.html'
    ],
