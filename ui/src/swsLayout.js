import JSONFormatter from './plugins/json-formatter/json-formatter.esm';
...
function showDetails(row) {
  ...
  code.appendChild(formatter.render());
        ...
        r1: {
          columns: {
            sws_rates_wApd: {
              class: "col-md-2",
              type: "widget",
              title: 'Current Apdex Score',
              subtitle: 'Apdex Score on last time interval',
              postProcess: 'successIfNonZero',
            },
            sws_rates_wRqR: {
              class: "col-md-2",
            ...
            sws_rates_wMHT: {
              class: "col-md-2",
              type: "widget",
              title: 'Current Max HT',
              subtitle: 'Longest Req on last 60 sec',
              postProcess: 'successIfNonZero',
            },
            sws_rates_wAHT: {
              class: "col-md-2",
              type: "widget",
              title: 'Current Avg HT',
              subtitle: 'Avg Handle Time on last 60 sec',
              postProcess: 'successIfNonZero',
            },
            sws_rates_wSHT: {
              class: "col-md-2",
              type: "widget",
              title: 'Current Sum HT',
              subtitle: 'Sum Handle Time on last 60 sec',
              postProcess: 'successIfNonZero',
            },
          },
        },
        r2: {
          columns: {
            sws_rates_wOApd: {
              class: "col-md-2",
              type: "widget",
              title: 'Overall Apdex Score',
              subtitle: 'Apdex Score of all time',
              postProcess: 'successIfNonZero',
            },
            sws_rates_wORqR: {
              class: "col-md-2",
              type: "widget",
              title: 'Overall Req Rate',
              subtitle: 'Req rate of all time',
              postProcess: 'successIfNonZero',
            },
            sws_rates_wOErR: {
              class: "col-md-2",
              type: "widget",
              title: 'Overall Err Rate',
              subtitle: 'Err rate of all time',
              postProcess: 'redIfNonZero',
            },
            sws_rates_wOMHT: {
              class: "col-md-2",
              type: "widget",
              title: 'Overall Max HT',
              subtitle: 'Longest Req of all time',
            },
            sws_rates_wOAHT: {
              class: "col-md-2",
              type: "widget",
              title: 'Overall Avg HT',
              subtitle: 'Avg Handle Time of all time',
            },
            sws_rates_wOSHT: {
              class: "col-md-2",
              type: "widget",
              title: 'Overall HT',
              subtitle: 'Sum Handle Time of all time',
            },
          },
        },
        ...
        r1: {
          columns: {
            sws_payl_wTRqP: {
              ...
              type: "widget",
              title: 'Received',
              subtitle: 'Sum requests content len',
              postProcess: 'successIfNonZero',
            },
            sws_payl_wMRqP: {
              class: "col-md-2",
              type: "widget",
              title: 'Max Req Payload',
              subtitle: 'Max request content len',
              postProcess: 'successIfNonZero',
            },
            sws_payl_wARqP: {
              class: "col-md-2",
              type: "widget",
              title: 'Avg Req Payload',
              subtitle: 'Avg request content len',
              postProcess: 'successIfNonZero',
            },
            sws_payl_wTRsP: {
              class: "col-md-2",
              type: "widget",
              title: 'Sent',
              subtitle: 'Sum response content len',
              postProcess: 'successIfNonZero',
            },
            sws_payl_wMRsP: {
              class: "col-md-2",
              type: "widget",
              title: 'Max Res Payload',
              subtitle: 'Max response content len',
              postProcess: 'successIfNonZero',
            },
            sws_payl_wARsP: {
              class: "col-md-2",
              type: "widget",
              title: 'Avg Res Payload',
              subtitle: 'Avg response content len',
              postProcess: 'successIfNonZero',
            },
          },
        },
        ...
        r2: {
          columns: {
            sws_apiop_wRq: {
              ...
              type: "widget",
              title: 'Requests',
              subtitle: 'Total received requests',
            },
            sws_apiop_wApd: {
              class: "col-md-2",
              type: "widget",
